  ...
  return (
    <div className="lg:px-36 px-2">
      ...
      <div className="grid lg:grid-cols-2  gap-4 lg:gap-16">
        <div data-aos="zoom-in-right" data-aos-duration="1000" className="grid grid-cols-2 gap-4 items-center shadow-xl background-color rounded-xl lg:p-20 p-4 font-bold">
        ...
        <div data-aos="zoom-in-left" data-aos-duration="1000" className="grid grid-cols-2 gap-4 items-center shadow-xl background-color rounded-xl lg:p-20 p-4 font-bold">
